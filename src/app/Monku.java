...
public class Monku {
    ...
    public static Monster[] monsters1 = {new AirType("Pigdeot", 0, 0, "asset/Dungeon/Obsidian Fortress lvl1/pigdeot/pidgeot.gif"), new WaterType("Kingdra", 0, 0, "asset/Dungeon/Obsidian Fortress lvl1/Kingdra/kingdra.gif"), new EarthType("Golem", 0, 0, "asset/Dungeon/Obsidian Fortress lvl1/golem/golem.gif"), new FireType("Arcanine", 0, 0, "asset/Dungeon/Obsidian Fortress lvl1/arcanine/arcanine.gif"), new IceType("Glaceon", 0, 0, "asset/Dungeon/Obsidian Fortress lvl1/glaceon/glaceon.gif")};
    ...
    public static Monster[] monsters2 = {new AirType("Noctowl", 0, 0, "asset/Dungeon/Inferno Abyss lvl2/noctowl/noctowl.gif"), new WaterType("Milotic", 0, 0, "asset/Dungeon/Inferno Abyss lvl2/milotic/milotic.gif"), new EarthType("Rhyperior", 0, 0, "asset/Dungeon/Inferno Abyss lvl2/Rhyperior/rhyperior.gif"), new FireType("Arcanine", 0, 0, "asset/Dungeon/Inferno Abyss lvl2/infernape/infernape.gif"), new IceType("Weavile", 0, 0, "asset/Dungeon/Inferno Abyss lvl2/Weavile/weavile.gif")};
    ...
    public static Monster[] monsters3 = {new AirType("Crobat", 0, 0, "asset/Dungeon/Crypt of Whispers lvl3/Crobat/crobat.gif"), new WaterType("Lapras", 0, 0, "asset/Dungeon/Crypt of Whispers lvl3/Lapras/lapras.gif"), new EarthType("Hippowdon", 0, 0, "asset/Dungeon/Crypt of Whispers lvl3/Hippowdon/hippowdon.gif"), new FireType("Chandelure", 0, 0, "asset/Dungeon/Crypt of Whispers lvl3/Chandelure/chandelure.gif"), new IceType("Beartic", 0, 0, "asset/Dungeon/Crypt of Whispers lvl3/Beartic/beartic.gif")};
    ...
    public static Monster[] monsters4 = {new AirType("Staraptor", 0, 0, "asset/Dungeon/Dungeon of Eternal Night lvl4/Staraptor/staraptor.gif"), new WaterType("Staraptor", 0, 0, "asset/Dungeon/Dungeon of Eternal Night lvl4/Staraptor/staraptor.gif"), new EarthType("Krookodile", 0, 0, "asset/Dungeon/Dungeon of Eternal Night lvl4/Krookodile/krookodile.gif"), new FireType("Typhlosion", 0, 0, "asset/Dungeon/Dungeon of Eternal Night lvl4/Typhlosion/typhlosion.gif"), new IceType("Walrein", 0, 0, "asset/Dungeon/Dungeon of Eternal Night lvl4/Walrein/walrein.gif")};
    ...
    public static Monster[] monsters5 = {new AirType("Aerodactyl", 0, 0, "asset/Dungeon/Temple of Doom lvl5/aerodactyl/aerodactyl.gif"), new WaterType("Gyarados", 0, 0, "asset/Dungeon/Temple of Doom lvl5/gyarados/gyarados.gif"), new EarthType("Aggron", 0, 0, "asset/Dungeon/Temple of Doom lvl5/aggron/aggron.gif"), new FireType("Blaziken", 0, 0, "asset/Dungeon/Temple of Doom lvl5/Blaziken/blaziken.gif"), new IceType("Abomasnow", 0, 0, "asset/Dungeon/Temple of Doom lvl5/Abomasnow/abomasnow.gif")};
